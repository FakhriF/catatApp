...
class NotesListWidget extends StatefulWidget {
  ...
  @override
  State<NotesListWidget> createState() => NotesListWidgetState();
}
...
class NotebookListWidget extends StatelessWidget {
  const NotebookListWidget({
    Key? key,
  }) : super(key: key);
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                StreamBuilder(
                  stream:
                      getNotebooks(uid: FirebaseAuth.instance.currentUser?.uid),
                              ...
                              child: ListTile(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: ((context) => ReadNotebooksPage(
                                            notebooksName:
                                                notebooks['Notebook'],
                ...
                ListTile(
                  ...
                  title: Text(
                    "Tambah Buku Catatan",
                    style: TextStyle(color: Color.fromRGBO(18, 212, 146, 1)),
                  ),
                  onTap: () {
                    createNotebook(context: context);
                  },
